...
import { NavLink } from "react-router-dom"; // 建議確認是否為 react-router-dom
  ...
  return (
    <div className="bg-secondary-50 py-48 py-md-100">
      <div className="container text-sans gap-48">
        <div className="row">
          {/* 🚩 修正：原 ccol-md-6 多了一個 c */}
          <div className="col-md-6 footer-style">
            <h1>
              <NavLink to="/">
                <img src={logoPawarm} alt="pawarm LOGO" />
              </NavLink>
            </h1>
            ...
            <div className="col align-self-center ps-0 pe-0 pb-48 footer-style">
              <ul className="footer-content ps-0 gap-16 d-flex flex-column flex-md-row">
                {/* 🚩 修正：移除了文字間隱藏的不規則空白 */}
                <li><NavLink to='products'>選擇我的動物</NavLink></li>
                <li><NavLink to="milestone">查看公益里程碑</NavLink></li>
                <li><NavLink to='animaltracking'>追蹤動物</NavLink></li>
          ...
          <div className="col col-md-6">
            ...
            <div className="d-flex flex-column flex-md-row mb-3 email-input">
              <input type="email" className="form-control fw-500 eNews" id="eNewsLetterEmail" placeholder="請輸入 E-mail"/>
              <button className="btn btn-primary-500 px-md-44 py-md-16 text-nowrap eNews" type="button" id="sub-button">訂閱</button>
            </div>
          </div>

          <div className="copyright">
            <p>Copyright © 2025 Pawarm | 本網站僅供個人作品使用，不提供商業用途</p>
          </div>
        </div>
      </div>
    </div>
