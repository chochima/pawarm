...
const About = () => {
  ...
  return (
    <div className="about-page bg-white overflow-hidden">
      ...
      {/* 2. Mission Section - 文字與物種圖片連結 (關鍵修改區) */}
          ...
          <div className="row g-4 justify-content-center">
            {[
              ...
              <div className="col-md-4" key={index}>
                <div className="card h-100 border-0 shadow-sm overflow-hidden rounded-4 transition-transform hover-translate-y">
                  <img src={value.img} className="card-img-top object-fit-cover" style={{ height: '220px' }} alt={value.title} />
                  <div className="card-body p-40">
                    <h5 className="fw-bold mb-3 text-success-800">{value.title}</h5>
                    <p className="text-gray-500 small mb-0">{value.desc}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <style>{`
        ...
        .p-40 { padding: 40px; }
        .p-60 { padding: 60px; }
        .hover-translate-y { transition: all 0.3s ease; }
        ...
        .bg-primary-100 { background-color: #E6F0E6; }
